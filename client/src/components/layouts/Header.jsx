...
import { Button, Collapse, IconButton, Input, Menu, MenuHandler, MenuList, Navbar, Typography } from '@material-tailwind/react';
		...
		<header>
			<Navbar className="mx-auto max-w-screen-xl px-4 py-2 lg:px-8 lg:py-4">
				<div className="container mx-auto flex flex-wrap items-center justify-between text-blue-gray-900">
					<Link to={'/'} className="block antialiased font-sans text-base leading-relaxed text-inherit mr-4 cursor-pointer py-1.5 font-medium">
						eCourse 🎓
					</Link>
					<div className="hidden lg:block">{navList}</div>
					<form onSubmit={handleSubmit} className="hidden items-center gap-x-2 lg:flex">
						...
						<Button size="md" className="rounded-lg " type='submit'>
							Search
						</Button>
					</form>
					<IconButton
